...
public final class Pharmacy extends Root implements PharmacyInterface {
    ...
    public void addCash(double profit) {
        ...
        System.out.println(profit + " dollars added to the cash register of the pharmacy with id " + this.id);
    }
